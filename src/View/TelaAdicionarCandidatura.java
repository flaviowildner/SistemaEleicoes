...
public class TelaAdicionarCandidatura extends View {
    ...
    public TelaAdicionarCandidatura(Sistema sistema, Usuario usuario, ProcessoEleitoral processoEleitoral, Eleicao eleicao){
        super(sistema, usuario, "Adicionar Candidatura - " + eleicao.toString());
